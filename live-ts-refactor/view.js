...
var _View_instances, _View_updateScoreboard, _View_openModal, _View_closeAll, _View_clearMoves, _View_initializeMoves, _View_closeModal, _View_closeMenu, _View_toggleMenu, _View_handlePlayerMove, _View_setTurnIndicator, _View_qs, _View_qsAll, _View_delegate;
class View {
    constructor() {
        ...
        this.$.menuBtn.addEventListener("click", (event) => __classPrivateFieldGet(this, _View_instances, "m", _View_toggleMenu).call(this));
    }
    render(game, stats) {
